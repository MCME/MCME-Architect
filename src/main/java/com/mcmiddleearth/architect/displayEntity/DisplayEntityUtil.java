...
public class DisplayEntityUtil {
    ...
    public static Map<String,Object> serializeDisplayEntity(Display displayEntity) {
        Map<String,Object> result = serializeEntity(displayEntity);
    ...
    public static ArmorStand deserializeDisplayEntity(Map<String,Object> data) {

...
//END DELETE
    ...
    DISPLAY_ENTITY_EDITOR    ("architect.displayEntityEditor"),
    DISPLAY_ENTITY_EDITOR_TRUSTED ("architect.displayEntityEditor.trusted"),
    DISPLAY_ENTITY_EDITOR_DELETE  ("architect.displayEntityEditor.delete"),
